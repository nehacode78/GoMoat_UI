    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="col-md-12">
                ...
                'svg' => '<svg class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <table class="table no-margin">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if (!empty($customers_count_by_source[$source->id]) &&
                            !empty($contacts_count_by_source[$source->id]))
                            @php
                            $conversion =
