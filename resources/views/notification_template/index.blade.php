...
<section class="content-header">
    <h1 class="tw-text-lg md:tw-text-2xl tw-font-semibold tw-text-black">{{ __('lang_v1.notification_templates')}}</h1>
</section>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.supplier_notifications') . ':'])
                ...
                <div class="callout callout-warning custom-callout">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <button type="submit" class="tw-dw-btn  btn-brand tw-text-white">@lang('messages.save')</button>
        </div>
    </div>
    {!! Form::close() !!}
