...
<section class="content-header">
    <h1 class="tw-text-lg md:tw-text-2xl tw-font-semibold tw-text-black">@lang( 'tax_rate.tax_rates' )
...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'tax_rate.all_your_tax_rates' )])
        @can('tax_rate.create')
            @slot('tool')
                <div class="box-tools">
                    <button class="tw-dw-btn btn-brand tw-font-bold tw-text-white tw-border-none tw-rounded-full btn-modal pull-right"
