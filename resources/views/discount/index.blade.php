...
@section('content')
    ...
    <section class="content-header">
        <h1 class="tw-text-lg md:tw-text-2xl tw-font-semibold tw-text-black">@lang('sale.discount')
        </h1>
        ...
        <div
            ...
            <div class="tw-p-4 sm:tw-p-5">
                <div class="tw-flex tw-gap-2.5 tw-justify-end">
                    @can('brand.create')
                            <a class="tw-dw-btn btn-brand tw-font-bold tw-text-white tw-border-none tw-rounded-full btn-modal pull-right"
                                            ...
                                            <td colspan="11">
                                                <div style="display: flex; width: 100%;">
                                                    ...
                                                    {!! Form::submit(__('lang_v1.deactivate_selected'), [
                                                        'class' => 'tw-dw-btn tw-dw-btn-warning  bg-green  tw-text-white tw-dw-btn-xs',
