...
<section class="content-header">
    <h1 class="tw-text-lg md:tw-text-2xl tw-font-semibold tw-text-black">@lang('expense.expenses')</h1>
</section>
                ...
                @can('expense.add')
                    @slot('tool')
                        <div class="box-tools">
                            ...
                            <a class="tw-dw-btn btn-brand tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right tw-m-2"
                            ...
                            <a class="tw-dw-btn btn-brand tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right tw-m-2"
