...
@section('content')
    ...
    <section class="content-header">
        <h1 class="tw-text-lg md:tw-text-2xl tw-font-semibold tw-text-black">@lang('lang_v1.add_stock_transfer')</h1>
    </section>
        ...
        @component('components.widget', ['class' => 'box-solid'])
            ...
            <div class="row">
                ...
                <div class="col-sm-12 text-center">
                    <button type="submit" id="save_stock_transfer" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-md tw-text-white">@lang('messages.save')</button>
                </div>
            </div>
        @endcomponent
