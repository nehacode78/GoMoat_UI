...
<section class="content-header">
    <h1 class="tw-text-lg md:tw-text-2xl tw-font-semibold tw-text-black">@lang( 'business.business_locations' )
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'business.all_your_business_locations' )])
        @slot('tool')
            <div class="box-tools">
                ...
                <button class="tw-dw-btn btn-brand tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right tw-mb-2 btn-modal"
