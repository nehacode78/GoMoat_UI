...
<section class="content-header">
    <h1 class="tw-text-lg md:tw-text-2xl tw-font-semibold tw-text-black">@lang('stock_adjustment.stock_adjustments')
        <small></small>
    </h1>
</section>
        ...
        @slot('tool')
            <div class="box-tools">
                @if(auth()->user()->can('stock_adjustment.create'))
                    <a class="tw-dw-btn btn-brand tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
