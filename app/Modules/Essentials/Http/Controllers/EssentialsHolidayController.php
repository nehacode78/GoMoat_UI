...
class EssentialsHolidayController extends Controller
{
    ...
    public function index()
    {
        ...
        if (! (
            ...
            auth()->user()->can('essentials.all_holidays') ||
    ...
    public function store(Request $request)
    {
        ...
        if (! (auth()->user()->can('superadmin') || auth()->user()->can('essentials.add_holiday') ||$this->moduleUtil->hasThePermissionInSubscription($business_id, 'essentials_module'))) {
            abort(403, 'Unauthorized action.');
        }
    ...
    public function edit($id)
    {
        ...
        if (! (auth()->user()->can('superadmin') || auth()->user()->can('essentials.edit_holiday') || $this->moduleUtil->hasThePermissionInSubscription($business_id, 'essentials_module'))) {
            abort(403, 'Unauthorized action.');
        }
    ...
    public function destroy($id)
    {
        ...
        if (! (auth()->user()->can('superadmin') || auth()->user()->can('essentials.delete_holiday') || $this->moduleUtil->hasThePermissionInSubscription($business_id, 'essentials_module'))) {
            abort(403, 'Unauthorized action.');
        }
