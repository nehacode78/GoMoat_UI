                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            !!}
                            {!! Form::text('payroll_group_name', !empty($payroll_group) ? $payroll_group->name :
                            strip_tags($group_name), ['class' => 'form-control', 'placeholder' => __(
                            'essentials::lang.payroll_group_name' ), 'required']); !!}
                        </div>
                        <div class="col-md-4">
                            {!! Form::label('payroll_group_status', __( 'sale.status' ) . ':*') !!}
                            @show_tooltip(__('essentials::lang.group_status_tooltip'))
                            {!! Form::select('payroll_group_status', ['draft' => __('sale.draft'), 'final' =>
                            __('sale.final')], !empty($payroll_group) ? $payroll_group->status : null, ['class' =>
                            'form-control select2', 'required', 'style' => 'width: 100%;', 'placeholder' => __(
                            'messages.please_select' )]); !!}
                            <p class="help-block text-muted">@lang('essentials::lang.payroll_cant_be_deleted_if_final')
                            </p>
                        </div>
                    </div><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="employee-summary-box">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4><b>Name:</b> {{ $payroll['name'] }}</h4>
                                        <p><b>Leaves:</b> {{ $payroll['total_leaves'] }} days</p>
                                        <p><b>Attendance:</b> {{ $payroll['total_days_worked'] }} days</p>
                                    </div>

                                    <div class="col-md-6 wd">
                                        <p><b>Work Duration:</b> {{ $payroll['total_work_duration'] }} hours</p>
                                        <p><b>Pay Period:</b> {{ $payroll['essentials_pay_period'] ?? 'Month' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="employee-summary-box">
                            <div class="row">
                                ...
                                @endphp
                                <div class="col-md-3">
                                    <h4 class="mb-2">@lang('essentials::lang.allowances')</h4>
                                    <p class="mb-5">{!! Form::label('essentials_duration_'.$employee, __(
                                        'essentials::lang.total_work_duration' ) . ':*') !!}
                                        {!! Form::text('payrolls['.$employee.'][essentials_duration]',
                                        $total_work_duration,
                                        ['class' => 'form-control input_number essentials_duration', 'placeholder'
                                        => __(
                                        'essentials::lang.total_work_duration' ), 'required', 'data-id' =>
                                        $employee, 'id'
                                        => 'essentials_duration_'.$employee]); !!}</p>

                                    <p class="mb-5">{!! Form::label('essentials_duration_unit_'.$employee, __(
                                        'essentials::lang.duration_unit' ) . ':') !!}
                                        {!! Form::text('payrolls['.$employee.'][essentials_duration_unit]',
                                        $duration_unit,
                                        ['class' => 'form-control', 'placeholder' => __(
                                        'essentials::lang.duration_unit' ),
                                        'data-id' => $employee, 'id' => 'essentials_duration_unit_'.$employee]); !!}
                                    </p>
                                </div>

                                <div class="col-md-3 wd">
                                    <p class="mb-5">{!!
                                        Form::label('essentials_amount_per_unit_duration_'.$employee, __(
                                        'essentials::lang.amount_per_unit_duartion' ) . ':*') !!}
                                        {!!
                                        Form::text('payrolls['.$employee.'][essentials_amount_per_unit_duration]',
                                        $amount_per_unit_duration, ['class' => 'form-control input_number
                                        essentials_amount_per_unit_duration', 'placeholder' => __(
                                        'essentials::lang.amount_per_unit_duartion' ), 'required', 'data-id' =>
                                        $employee,
                                        'id' => 'essentials_amount_per_unit_duration_'.$employee]); !!}</p>
                                    <p class="mb-5">
                                        {!! Form::label('total_'.$employee, __( 'sale.total' ) . ':') !!}
                                        {!! Form::text('payrolls['.$employee.'][total]', $total, ['class' =>
                                        'form-control
                                        input_number total', 'placeholder' => __( 'sale.total' ), 'data-id' =>
                                        $employee,
                                        'id' => 'total_'.$employee]); !!}
                                        </td>
                                    </p>
                                ...
                                <td>
                                    ...
                                    <table class="table table-condenced allowance_table"
                                        ...
                                        <tbody>
                                            ...
                                            ['add_button' =>
                                            $loop->index == 0 ? true : false, 'type' => 'allowance', 'name' =>
                                            $value,
                                            'value' => $payroll['allowances']['allowance_amounts'][$key],
                                            'amount_type' =>
                                            $payroll['allowances']['allowance_types'][$key],
                                            ...
                                            ['add_button' =>
                                            true, 'type' => 'allowance'])
                                            @include('essentials::payroll.allowance_and_deduction_row', ['type' =>
                                            'allowance'])
                                            @include('essentials::payroll.allowance_and_deduction_row', ['type' =>
                                            'allowance'])
                                            @endif
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><span id="total_allowances_{{$employee}}" class="display_currency"
                                ...
                                <td>
                                    ...
                                    <table class="table table-condenced deductions_table"
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th colspan="2">@lang('sale.total')</th>
                                                <td><span id="total_deductions_{{$employee}}" class="display_currency"
                                    ...
                                    <br><br><br><br><br>
                                    <span style="float:right;"><b>@lang('essentials::lang.gross_amount')</b><span>
                                            <br>
                                            <span id="gross_amount_text_{{$employee}}" class="gross-amount-value">₹
                                                0.00</span>
                                            <br>
                                            {!! Form::hidden(
                                            'payrolls['.$employee.'][final_total]',
                                            0,
                                            ['id' => 'gross_amount_'.$employee, 'class' => 'gross_amount']
                                            ); !!}
                                </td>
                                <!-- <td>
                                        <strong>
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::textarea('payrolls['.$employee.'][staff_note]',
                                        $payroll['staff_note'] ??
                                        null, ['class' => 'form-control', 'placeholder' => __( 'sale.total' ), 'id'
                                        =>
                                        'note_'.$employee, 'rows' => 3]); !!}
                                    </div>
                                </td>
                            </tr>
