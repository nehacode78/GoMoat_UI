...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box-tools">
                <button type="button"
                    class="tw-dw-btn btn-brand tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right btn-modal"
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                if ($('#holiday_filter_date_range').val()) {
                    d.start_date = $('#holiday_filter_date_range').data('daterangepicker').startDate
                        .format('YYYY-MM-DD');
                    d.end_date = $('#holiday_filter_date_range').data('daterangepicker').endDate
                        .format('YYYY-MM-DD');
                }
            }
        },
